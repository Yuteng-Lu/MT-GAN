...
# change association at line 88 and 110
...
def save_plot(examples, epoch, n=10):
    ...
    # save plot to file
    filename = 'cd_generated_plot_e%03d.png' % (epoch + 1)
...
def summarize_performance(epoch, g_model, d_model, dataset, latent_dim, n_samples=100, save=True):
    ...
    if save:
        ...
        filename = 'cd_generator_model_%03d.h5' % (epoch + 1)
        g_model.save(filename)
        filename = 'cd_discriminator_model_%03d.h5' % (epoch + 1)
