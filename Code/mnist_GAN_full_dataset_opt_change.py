...
def define_discriminator(in_shape=(28, 28, 1)):
    ...
    # compile model
    opt = Adam(lr=0.0004, beta_1=0.5)  # 0.0002 to 0.0004
...
def save_plot(examples, epoch, n=10):
    ...
    # save plot to file
    filename = 'oc_generated_plot_e%03d.png' % (epoch + 1)
...
def summarize_performance(epoch, g_model, d_model, dataset, latent_dim, n_samples=100, save=True):
    ...
    if save:
        ...
        filename = 'oc_generator_model_%03d.h5' % (epoch + 1)
        g_model.save(filename)
        filename = 'oc_discriminator_model_%03d.h5' % (epoch + 1)
